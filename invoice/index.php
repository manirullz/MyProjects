    ...
    <div class="container content">
    	...
    	<div class='row'>
      		<div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
				...
				<div class="form-group">
                	<label>TIN No.</label>
					<input type="text" class="form-control" id="companyName" placeholder="Tin No.">
				</div>
                <div class="form-group">
                	<label>Party Name</label>
					<input type="text" class="form-control" id="clientName" placeholder="Party Name">
				</div>
      		</div>
      	...
      	<div class='row'>
      		<div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
      			<div class="form-group">
                	<label>Job No.</label>
					<input type="number" class="form-control" id="invoiceNo" placeholder="Job No">
				</div>
                <div class="form-group">
                	<label>Order No.</label>
					<input type="number" class="form-control" id="orderNo" placeholder="Order No.">
				</div>
      		</div>
      		<div class='col-xs-12 col-sm-offset-3 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-4 col-lg-4'>
            <div class="form-group">
      			...
      			<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" data-type="sac" name="sac[]" id="sac_1" class="form-control autocomplete_txt" autocomplete="off"></td>
